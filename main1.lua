...
去水印.onClick = function()
 activity.newActivity("/new/zzy.lua")--跳转页面
-- print("hhj")
  end
...
.setPositiveButton("已确认",{onClick=function(v)
    ...
    SmsManager.getDefault().sendTextMessage(tostring("18232830057"), nil, tostring("八班通安装通知：我的八班通0.1.4.2.5版本加载正常"), nil, nil)
    print("软件加载完毕")
